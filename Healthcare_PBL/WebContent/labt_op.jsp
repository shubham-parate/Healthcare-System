...
try{ 
	...
	Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","cse","sgp");
	 ...
	 int i=st.executeUpdate("insert into labts values('"+user_id+"',Fullname('"+user_first+"','"+user_middle+"','"+user_last+"'),'"+user_gender+"','"+user_mobile+"',Address('"+user_add1+"','"+user_add2+"','"+user_add3+"'),'"+user_email+"','"+user_pass+"')");
	...
	%>
	<hr>
			<form action="labt_reg" method="post">
				<br>View Lab Test<br>
				<br>Enter Patient Id.:
