 ...
 */
@WebServlet("/search_dr")
public class search_dr extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{ 
			...
			Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","cse","sgp");
			 ...
			 String sqlQuery="select d.license, d.name.fname , d.name.mname , d.name.lname , d.gender, d.phone, d.address.street , d.address.city , d.address.pincode , d.email, d.pass from doctors d where license = "+roll_no+"" ;
