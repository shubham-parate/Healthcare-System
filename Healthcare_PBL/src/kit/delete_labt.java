...
/**
 * Servlet implementation class delete_labt
 */
@WebServlet("/delete_labt")
public class delete_labt extends HttpServlet {
...
PrintWriter pw = response.getWriter();
		...
		try{ 
			...
			Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","cse","sgp");
			 ...
			 String sqlQuery="delete from labts where license_no = "+roll_no+"" ;
			 ...
			 {
				 flag=1;
				 pw.println("Lab Assistant Successfuly Deleted = "+roll_no);
