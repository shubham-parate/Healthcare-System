...
/**
 * Servlet implementation class show_dr
 */
@WebServlet("/show_dr")
public class show_dr extends HttpServlet {
...
PrintWriter pw = response.getWriter();
		...
		try{ 
			...
			Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","cse","sgp");
			 ...
			 String sqlQuery="select d.license, d.name.fname , d.name.mname , d.name.lname , d.gender, d.phone, d.address.street , d.address.city , d.address.pincode , d.email, d.pass from doctors d" ;
