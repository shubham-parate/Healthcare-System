...
/**
 * Servlet implementation class delete_dr
 */
@WebServlet("/delete_dr")
public class delete_dr extends HttpServlet {
...
PrintWriter pw = response.getWriter();
		...
		try{ 
			...
			Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","cse","sgp");
			 ...
			 String sqlQuery="delete from doctors where license = "+roll_no+"" ;
			 ...
			 {
				 flag=1;
				 pw.println("Doctor Successfuly Deleted = "+roll_no);
