...
/**
 * Servlet implementation class search_labt
 */
@WebServlet("/search_labt")
public class search_labt extends HttpServlet {
...
PrintWriter pw = response.getWriter();
		...
		try{ 
			...
			Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","cse","sgp");
			 ...
			 String sqlQuery="select d.license_no, d.name.fname , d.name.mname , d.name.lname , d.gender, d.phone, d.address.street , d.address.city , d.address.pincode , d.email, d.pass from labts d where license_no = "+roll_no+"" ;
